...
public class CustomerActivity extends AppCompatActivity {
    ...
    private void getUserDetails(){
        if (mUserLocation == null){
            ...
            DocumentReference userRef = mDb.collection(getString(R.string.collection_customers))
    ...
    private void savedUserLocation(){
        ...
        if (mUserLocation != null){
            DocumentReference locationRef = mDb.
                    collection(getString(R.string.collection_customers_locations))
                    .document(FirebaseAuth.getInstance().getUid());
    ...
    public boolean isServicesOK(){
        ...
        int available = GoogleApiAvailability.getInstance().isGooglePlayServicesAvailable(CustomerActivity.this);
        ...
        if(available == ConnectionResult.SUCCESS){
            ...
            Dialog dialog = GoogleApiAvailability.getInstance().getErrorDialog(CustomerActivity.this, available, ERROR_DIALOG_REQUEST);
            dialog.show();
        }else{
